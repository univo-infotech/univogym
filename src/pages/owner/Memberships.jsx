              ...
              >
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    >
                      <span className={`w-1.5 h-1.5 rounded-full ${p.isActive !== false ? "bg-emerald-500 animate-pulse" : "bg-rose-500"}`} />
                ...
                <div className="p-3 bg-slate-50 border-t border-slate-100 flex items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    title={p.isActive !== false ? "Click to Deactivate" : "Click to Activate"}
                  >
                    <span className={`w-2 h-2 rounded-full ${p.isActive !== false ? "bg-emerald-500 animate-pulse" : "bg-rose-500"}`} />
                    {p.isActive !== false ? "Active" : "Inactive"}
                  </button>
